        ...
        <form action="{{route('customer.withdraw_request')}}" method="POST" class="withdraw_form">
             ...
             <div class="from-group mt-3">
                <label for="amount">Amount <strong class="text-danger"> (Current Balance {{Auth::guard('customer')->user()->balance}} TK)</strong></label>
                 <input type="number" id="amount" name="amount" class="form-control border mt-2" placeholder="Enter Amount" required>
             </div>
             <div class="from-group mt-3">
             ...
             <div class="from-group mt-3">
                <label for="amount">Receive Number</label>
                 <input type="number" id="amount" name="receive" class="form-control border mt-2" placeholder="Enter Receive Number" required>
             </div>
             <div class="from-group mt-3">
                <label for="note">Note</label>
                 <textarea  id="note" name="note" class="form-control border mt-2" placeholder="Write your payment receive information"></textarea>
             </div>
             <div class="from-group mt-3">
                <label for="password"> Your Password</label>
                 <input type="password" id="password" name="password" class="form-control border mt-2" placeholder="Enter Your Password" required>
             </div>
             <div clas
