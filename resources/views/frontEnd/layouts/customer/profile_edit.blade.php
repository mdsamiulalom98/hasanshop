                        ...
                        <form action="{{ route('customer.profile_update') }}" method="POST" class="row"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="area"
                                        class="form-control area select2 @error('area') is-invalid @enderror" name="area"
                                        value="{{ old('area') }}" required>
                                        <option value="">Select...</option>
                                        @foreach ($areas as $key => $area)
                                            <option value="{{ $area->id }}"
                                                @if ($profile_edit->area == $area->id) selected @endif>{{ $area->thana_name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" id="image"
                                        ...
                                        value="{{ Auth::guard('customer')->user()->image }}">
