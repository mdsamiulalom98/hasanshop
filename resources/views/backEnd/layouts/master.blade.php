...
<body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark"
    ...
    <div id="wrapper">
        <!-- Topbar Start -->
        <div class="navbar-custom content">
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-orders">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('admin.pos_orders') }}"><i
                                                data-feather="minus"></i> POS Orders</a>
                                    </li>
                                    <li>
                        ...
                        <!-- nav items end -->
                          <li>
                              <a href="#sidebar-affiliates" data-bs-toggle="collapse">
                                  <i data-feather="user"></i>
                                  <span> Affiliate</span>
                                  <span class="menu-arrow"></span>
                              </a>
                              <div class="collapse" id="sidebar-affiliates">
                                  <ul class="nav-second-level">
                                      <li>
                                          <a href="{{ route('affiliates.index', ['status' => 'pending']) }}"><i
                                                  data-feather="minus"></i> Pending Request </a>
                                      </li>
                                      <li>
                                          <a href="{{ route('affiliates.index', ['status' => 'cancelled']) }}"><i
                                                  data-feather="minus"></i> Cancelled  Request </a>
                                      </li>
                                      <li>
                                          <a href="{{ route('affiliates.index', ['status' => 'active']) }}"><i
                                                  data-feather="minus"></i> Active Request </a>
                                      </li>
                                  </ul>
                              </div>
                          </li>
                          ...
                          <li>
                              ...
                              <div class="collapse" id="sidebar-withdraw">
                                  <ul class="nav-second-level">
                                      <li>
                                          <a href="{{ route('admin.withdraw', 'pending') }}"><i data-feather="minus"></i> Pending Withdraw</a>
                                      </li>
                                      <li>
                                          <a href="{{ route('admin.withdraw', 'paid') }}">Paid Withdraw <i data-feather="minus"></i></a>
                                      </li>
                                      <li>
                                          <a href="{{ route('admin.withdraw', 'cancel') }}">Cancel Withdraw <i data-feather="minus"></i></a>
                                      </li>
                                  </ul>
                              </div>
                          </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sliders">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('sliders.create') }}"><i data-feather="minus"></i>New Slider</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('sliders.index') }}"><i data-feather="minus"></i>All Manage</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-specialoffer">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('specialoffer.create') }}"><i data-feather="minus"></i>
                                            Create</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('specialoffer.index') }}"><i data-feather="minus"></i>
                                            Manage</a>
                                    </li>
                                </ul>
                            </div>
