        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{ route('sliders.create') }}" class="btn btn-primary waves-effect waves-light btn-sm rounded-pill">Create</a>
                </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td>{{$value->title}}</td>
                                <td>{{Str::limit ($value->subtitle, 20)}}</td>
                                <td>{{Str::limit ($value->link, 20)}}</td>
                                <td>
