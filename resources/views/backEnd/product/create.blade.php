                    ...
                    <form action="{{ route('products.store') }}" method="POST" class="row" data-parsley-validate=""
                        ...
                        <div class="col-sm-3">
                          <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('commision') is-invalid @enderror" name="commision" value="{{ old('commision') }}" id="commision" />
                            @error('commision')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                <label for="imei" class="form-label">IMEI Number (Multiple)</label>
                                <input 
                                    type="text" 
                                    ...
                                    value="{{ old('imei', isset($product) ? implode(',', json_decode($product->imei, true)) : '') }}"
                                />
                                @error('imei')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
