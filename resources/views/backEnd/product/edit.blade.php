...
@section('css')
                    ...
                    <div class="card-body">
                        <form action="{{ route('products.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-4">
                             ...
                             <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    <label for="commision" class="form-label">Commision (Percentage) % </label>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="pro_barcode" value="{{ $edit_data->pro_barcode }}" {{ $edit_data->type == 0 ? 'disabled' : '' }} id="pro_barcode">
                                    @error('pro_barcode[]')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="variable_product">
                                    ...
                                    @foreach ($variables as $index => $variable)
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="pro_barcodes{{ $index }}" class="form-label">Product Barcode </label>
                                                    <input type="text"
                                                        class="form-control @error('stock') is-invalid @enderror"
                                                        name="pro_barcodes[]" value="{{ $variable->pro_barcode }}" id="pro_barcodes{{ $index }}">
                                                    @error('pro_barcodes[]')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    <label for="vat" class="form-label"> Vat (Persentize)</label>
                                    <input type="text"
                                        class="form-control @error('vat') is-invalid @enderror"
                                        name="vat" value="{{ $edit_data->vat }}"
                                        id="vat" />
                                    @error('vat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="imei" class="form-label">IMEI Numbers (Multiple)</label>
                                    <div id="imei-wrapper">
                                        @if(isset($edit_data->imei) && is_array($edit_data->imei))
                                            @foreach($edit_data->imei as $imei)
                                                <div class="input-group mb-2">
                                                    ...
                                                    />
                                                    <button type="button" class="btn btn-danger remove-imei">Remove</button>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="input-group mb-2">
                                    ...
                                    <button type="button" class="btn btn-primary mt-2" id="add-imei">Add IMEI</button>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            $('#product_type').change(function() {
                ...
                if (id == 1) {
                    ...
                    $('#pro_barcode').prop('disabled', false);
                } else {
                    $('.variable_product').show();
                    $('.normal_product').hide();
                    $('#pro_barcode').prop('disabled', true);
                }
            });
        });
    </script>
    ...
    <script>
        document.getElementById('add-imei').addEventListener('click', function () {
            const wrapper = document.getElementById('imei-wrapper');
        ...
        document.addEventListener('click', function (e) {
            if (e.target && e.target.classList.contains('remove-imei')) {
