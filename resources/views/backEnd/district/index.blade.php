                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#standard-modal">District Wise Charge</button>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-list">
                                                <a href="{{ route('districts.edit', $value->id) }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" required name="district" id="district">
                                ...
                                @foreach ($districts as $key => $district)
                                    <option value="{{ $district->id }}" data-amount="{{ $district->shippingfee }}">
