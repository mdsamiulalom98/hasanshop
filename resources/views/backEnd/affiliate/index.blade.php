    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{request()->status}} Affiliates</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">                                 
                                    ...
                                    <a href="{{route('affiliates.details',['id'=>$value->id])}}" class="btn btn-xs btn-blue waves-effect waves-light"><i class="fe-eye"></i></a>                                  
                                </div>
                            </td>
                        </tr>
                        @endforeach
