...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::get('cart/content-campaign', [ShoppingController::class, 'cart_content_camp'])->name('cart.content_camp');
     ...
     // compare route
    Route::get('compare/store', [ShoppingController::class, 'compare_store'])->name('compare.store');
    Route::get('compare', [ShoppingController::class, 'compare_show'])->name('compare.show');
    Route::get('compare/remove', [ShoppingController::class, 'compare_remove'])->name('compare.remove');
    Route::get('compare/count', [ShoppingController::class, 'compare_count'])->name('compare.count');
    Route::get('compare/summary', [ShoppingController::class, 'compare_summary'])->name('compare.summary');
...
Route::group(['prefix' => 'customer', 'namespace' => 'Frontend', 'middleware' => ['customer', 'ipcheck', 'check_refer']], function () {
    ...
    Route::get('/commisions', [CustomerController::class, 'commisions'])->name('customer.commisions');
    ...
    Route::get('/affiliate-request', [CustomerController::class, 'affiliate'])->name('customer.affiliate');
    Route::post('/affiliate-store', [CustomerController::class, 'affiliate_store'])->name('customer.affiliate_store');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    Route::get('pos-orders', [OrderController::class, 'pos_orders'])->name('admin.pos_orders');
    ...
    Route::get('affiliate/manage', [AffiliateController::class, 'index'])->name('affiliates.index');
    Route::get('affiliate/details', [AffiliateController::class, 'details'])->name('affiliates.details');
    Route::post('affiliate/request-status', [AffiliateController::class, 'request_status'])->name('affiliates.request_status');
