...
class OrderDetails extends Model
{
    ...
    public function allimei()
    {
        return $this->belongsTo(Product::class, 'product_id','id')->select('id','imei');
    }
    ...
    {
        return $this->belongsTo(Product::class, 'product_id','id')->select('id','warranty');
    }
}
