...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // IMEI ডেটা প্রক্রিয়াকরণ
        if ($request->has('imei') && !empty($request->imei)) {
            $imei_numbers = array_filter(array_map('trim', explode(',', $request->imei)));
            $input['imei'] = !empty($imei_numbers) ? json_encode($imei_numbers) : null;
        } else {
            $input['imei'] = NULL;
        }
    ...
    public function edit($id)
    {
        ...
        $edit_data->imei = $edit_data->imei ? json_decode($edit_data->imei, true) : [];
        // return $edit_data->imei;
    ...
    public function update(Request $request)
    {
        ...
        // IMEI ডাটা প্রক্রিয়াকরণ
        // $imei_numbers = array_filter(array_map('trim', $request->imei));
        // $input['imei'] = json_encode($imei_numbers);
