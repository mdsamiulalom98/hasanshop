...
class DashboardController extends Controller
{
    ...
    public function dashboard(Request $request){
        ...
        return view('backEnd.admin.dashboard',compact('order_statuses','total_sale','today_order','today_sales','current_month_sale'
        ,'total_order','current_month_order','total_customer','latest_order','dates_json','totals_json','products','variables','total_order','return_amount',
        'total_complete','total_process','delivery_amount','total_amount','process_amount','total_return'));
