...
class BannerController extends Controller
{
    ...
    {
        $banner_categories = BannerCategory::orderBy('id','DESC')->select('id','name')->get();
        //return $categories;
        return view('backEnd.banner.create',compact('banner_categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $banner_categories = BannerCategory::select('id','name')->get();
        return view('backEnd.banner.edit',compact('edit_data','banner_categories'));
    }
